...
Route::get('siswa/tambahpembayaran','SiswaController@tambahpembayaran');
Route::post('siswa/tambahpembayaran/store','SiswaController@store');
Route::delete('siswa/home/deletepembayaranpost{id_pembayaran}','SiswaController@deletepembayaranpost');
